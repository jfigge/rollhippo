...
/// Cancel, and the one that does the thing: the row of buttons every dialog
/// in this app ends with.
///
...
///
/// Down here beside [AppDialog] rather than beside any one of the dialogs that
/// uses it, because three of them do now and they are in two different files.
/// Three copies of one FilledButton differing only in what they are wired to
/// is three chances for one of them to be a different blue — the same argument
/// `menu.dart` makes about its switches.
