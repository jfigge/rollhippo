...
reason. Three dice across three decks is 648 cards. Up to four shoes at once,
...
promise the tray makes about a roll you have already thrown. They arrive one at
a time — what the picker shows you is the shoes you have started and one empty
one after them — so a table of one looks like a table of one.
